...
namespace EFT.HideOut
{
    ...
    public class PlayerESP : MonoBehaviour
    {
        ...
        private static void DrawBox(GamePlayer player)
        {
        ...
        private static void DrawHealthBar(GamePlayer player)
        {
            if (GameUtils.IsPlayerAlive(player.Player))
            {
                ...
                Render.DrawLine(
                    new Vector2((player.ScreenPosition.x - (boxWidth / 2f) - 3f), (boxPositionY + boxHeight - healthBarHeight)),
                    new Vector2((player.ScreenPosition.x - (boxWidth / 2f) - 3f), (boxPositionY + boxHeight)), 3f,
                    _healthColor);
            }
        }

        private static void DrawName(GamePlayer player)
        {
            Color playerColor;
            string playerText;
            //string weapon;
            ...
            Render.DrawLabel(new Rect(boundingVector.x - playerTextVector.x / 2f, Screen.height - boxVectorY - 20f, 300f, 50f),
